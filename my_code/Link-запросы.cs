/*
Текст задания
Фермер производит некоторую продукцию (зерно, мясо, фрукты, овощи и т. д.). Для производства требуется удовлетворить потребности (удобрения, орудия производства, транспортные услуги, строительные услуги и т. д.). 
Создать информационную систему для учета труда фермера.

Фермер	Продукция	Потребности
Ключ	Ключ	Ключ
ФИО	Название	Название
Адрес	Количество	Товар/Услуга
	Качество	Признак
	Отпускная цена	Цена
...
Руководителю области могут потребоваться следующие сведения:
•	Какую продукцию производят фермеры области.
•	Что требуется каждому фермеру для производства.
•	Какое количество заданной продукции производят фермеры.
•	Прибыль фермеров по каждому виду продукции.
•	Какой кредит требуется каждому фермеру.
•	Какова разница между кредитом и полученной прибылью.
Должна быть предусмотрена возможность добавления и удаления продукта.
*/
